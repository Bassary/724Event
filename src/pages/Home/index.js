    ...
    <>
      ...
      <footer className="row">
        <div className="col presta">
          ...
          {/* Encalpsulation de 'EventCard' dans la modal afin de l'afficher au clic */}
          {/* vérification de last par 'last &&' et ajout de last en tant que Children de 'ModalEvent' */}
          {last && (
            <Modal Content={<ModalEvent event={last} />}>
              {({ setIsOpened }) => (
                <EventCard
                  onClick={() => setIsOpened(true)} // ajout du 'onClick' pour activer la modal
                  imageSrc={last?.cover}
                  title={last?.title}
